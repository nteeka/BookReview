...
namespace KK_BookStore.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var nguoidung = from tt in myData.NguoiDungs where tt.TaiKhoan == user.UserName select tt;
           
            switch (result)
            {
                case SignInStatus.Success:
                    if (nguoidung.First().Banned == true)
                    {
        ...
        [AllowAnonymous]
        public ActionResult ErrorConfirmEmail()
        {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return RedirectToAction("xacNhanEmail", "Account");
                }
                AddErrors(result);
            }
        ...
        [HttpPost]  
        public ActionResult LayHinh(string Id)
        {
        ...
        [Authorize]
        public ActionResult themPhanHoi(string taikhoan, string noidung)
        {
            var phanhoi = new PhanHoi();
            phanhoi.TaiKhoan = taikhoan;
            phanhoi.NoiDung = noidung;
            phanhoi.NgayTao = DateTime.Now;
            UpdateModel(phanhoi);
            myData.PhanHois.InsertOnSubmit(phanhoi);
            myData.SubmitChanges();
